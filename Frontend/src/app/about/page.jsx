    ...
    return (
        <div className="about_container">
            <div className="about_section">
                <div className="about_heading mb-6">About Pathfinder</div>

                <p className="about_para mb-4">
            ...
            <div className="about_section about_borderTop">
                <h2 className="about_heading mb-6">About the Creator</h2>
