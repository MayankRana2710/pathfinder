...
export const LampContainer = ({
  ...
  return (
    <div
      ...
      <div
        className="relative flex w-full flex-1 scale-y-200 items-center justify-center isolate z-0 ">
        <motion.div
        ...
        <div
          className="absolute inset-auto z-50 h-50 w-[28rem] -translate-y-1/2 rounded-full bg-purple-500 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="absolute inset-auto z-30  w-64 -translate-y-[6rem] rounded-full bg-purple-400 blur-2xl"></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
      ...
      <div className="relative z-50 flex -translate-y-130 flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
